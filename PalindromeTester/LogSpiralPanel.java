...
the spiral.
*/
//int width = (int) Math.round(10*GOLDEN_MEAN);
//Rectangle mainRectangle = new Rectangle(0,0,width,10);
Graphics2D g2 = (Graphics2D) g;
//g2.draw(mainRectangle);
recursiveDraw(g2,0,0,100,90);
}
...
int y2 = (int) y;
int side2 = (int) side;
Rectangle newSquare = new Rectangle(x2,y2,side2,side2);
g2.draw(newSquare);
double newSide = (GOLDEN_MEAN*side) - side;
